...
public class List5Activity extends List  implements Runnable{
        ...
        handler = new Handler(){
            ...
            public void handleMessage(@NonNull Message msg) {
                if (msg.what==7){
                    ...
                    listItemAdapter = new SimpleAdapter(List5Activity.this, list2, // listItems数据源
    ...
    public void run() {
        ...
        Document doc = null;
        try{
            doc = Jsoup.connect("https://soccer.hupu.com/table/Germany.html").get();
